...
import BannerConstruction from "../components/offer-pages/road-construction-page/banner/banner";
import WhyUs from "../components/offer-pages/road-construction-page/why-us/why-us";
import Footer from "../components/footer/footer";
import WhatWeDo from "../components/offer-pages/road-construction-page/what-we-do/what-we-do";
    ...
    return (
        <>
            ...
            <main className='flex flex-col w-full items-center'>
                ...
                <WhyUs/>
                <WhatWeDo/>
                <ContactUs text='Do wykonania oferowanego zakresu posiadamy zaplecze sprzętowe pochodzące z renomowanych
