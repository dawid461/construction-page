...
import BannerConstruction from "../components/offer-pages/rental-page/banner/banner";
import WhyUs from "../components/offer-pages/rental-page/why-us/why-us";
import Footer from "../components/footer/footer";
import WhatWeDo from "../components/offer-pages/rental-page/what-we-do/what-we-do";
    ...
    return (
        <>
            ...
            <main className='flex flex-col w-full items-center'>
                ...
                <WhyUs/>
                <WhatWeDo/>
                <ContactUs text='Zajmujemy się szeroko rozumianym budownictwem, kolejnictwem oraz drogownictwem.
                 Jesteśmy innowacyjną grupą stawiającą sobie jak najwyższe poprzeczki, przez co ciągle się rozwijamy i
                  potrafimy spełnić każde oczekiwania klientów.'
                />
            </main>
