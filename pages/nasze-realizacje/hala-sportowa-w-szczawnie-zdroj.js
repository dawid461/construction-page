...
const SportsHallInSzczawnoZdroj = () => {

    const Images = [
        {id: 1, src: "/media/our-projects/portfolio/szczawno-zdroj-sports-hall/szczawno-zdroj-sports-hall-1.webp"},
        {id: 2, src: "/media/our-projects/portfolio/szczawno-zdroj-sports-hall/szczawno-zdroj-sports-hall-2.webp"},
        {id: 3, src: "/media/our-projects/portfolio/szczawno-zdroj-sports-hall/szczawno-zdroj-sports-hall-3.webp"},
        {id: 4, src: "/media/our-projects/portfolio/szczawno-zdroj-sports-hall/szczawno-zdroj-sports-hall-4.webp"},
        {id: 5, src: "/media/our-projects/portfolio/szczawno-zdroj-sports-hall/szczawno-zdroj-sports-hall-5.webp"},
    ];

    return (
        <>
            <Head>
                <title>Hala sportowa w Szczawnie-Zdrój</title>
...
export default SportsHallInSzczawnoZdroj;