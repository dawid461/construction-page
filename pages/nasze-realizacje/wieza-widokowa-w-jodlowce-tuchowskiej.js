...
const TowerInJodlowkaTuchowska = () => {

    const Images = [
        {id:1, src:"/media/our-projects/portfolio/jodlowka-tuchowska-tower/jodlowka-tuchowska-tower.webp"},
    ];

    return (
        <>
            <Head>
                <title>Wieża widokowa w Jodłówce Tuchowskiej</title>
            ...
            <main className='flex flex-col w-full items-center'>
                <BannerPortfolio
                    heading='Wieża widokowa w Jodłówce Tuchowskiej'
                    location='33-173 Jodłówka Tuchowska'
...
export default TowerInJodlowkaTuchowska;