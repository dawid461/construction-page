...
const SwimminPoolInGlucholazy = () => {

    const Images = [
        {id:1, src:"/media/our-projects/portfolio/glucholazy-swimming-pool/glucholazy-swimming-pool-1.webp"},
        {id:2, src:"/media/our-projects/portfolio/glucholazy-swimming-pool/glucholazy-swimming-pool-2.webp"},
        {id:3, src:"/media/our-projects/portfolio/glucholazy-swimming-pool/glucholazy-swimming-pool-3.webp"},
        {id:4, src:"/media/our-projects/portfolio/glucholazy-swimming-pool/glucholazy-swimming-pool-4.webp"},
        {id:5, src:"/media/our-projects/portfolio/glucholazy-swimming-pool/glucholazy-swimming-pool-5.webp"},
    ];

    return (
        <>
            <Head>
                <title>Basen w Głuchołazach</title>
...
export default SwimminPoolInGlucholazy;