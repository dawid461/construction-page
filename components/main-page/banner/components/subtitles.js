...
const Subtitles = () => {
    return (
        <>
            <div
                className='w-full h-96 max-w-screen-2xl flex flex-col items-center sm:justify-center md:justify-end xl:justify-center'>
                ...
                <motion.div animate={{x:[-100,0]}}
                            ...
                            whileInView={{ opacity: 1}}
                            viewport={{ once: true }}
                    className='flex bg-primaryColor sm:pb-1 xl:pb-2 sm:pt-1 xl:pt-2 sm:pr-6 xl:pr-8 sm:pl-6 xl:pl-8 sm:mt-3'>
                ...
                <motion.div animate={{x:[-100,0]}}
                            ...
                            whileInView={{ opacity: 1}}
                            viewport={{ once: true }}
                    className='flex bg-secondaryColor sm:pb-2 xl:pb-4 sm:pt-2 xl:pt-4 sm:pr-6 xl:pr-8 sm:pl-6 xl:pl-8 sm:mt-3'>
