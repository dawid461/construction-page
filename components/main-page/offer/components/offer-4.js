        ...
        <>
            <motion.div animate={{y: [50, 0]}}
                ...
                <div className='flex justify-center w-14 h-14 bg-primaryColor rounded-md'>
                    <Image src='/media/main-page/offer/icon-4.svg' width={40} height={40} alt=''/>
                </div>

                <h5 className='mt-3 text-black font-medium'>Wynajem</h5>

                <p className='w-11/12 mt-3 font-light text-sm text-center text-thirdColor leading-4'>
                    Dysponujemy bogatym parkiem maszynowym. Warunki wynajmu ustalamy zawsze indywidualnie z każdym
                    naszym kontrahentem
                </p>
