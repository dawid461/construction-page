        ...
        <>
            <motion.div animate={{y: [50, 0]}}
                ...
                <div className='flex justify-center w-14 h-14 bg-primaryColor rounded-md'>
                    <Image src='/media/main-page/offer/icon-1.svg' width={40} height={40} alt=''/>
                </div>

                <h5 className='mt-3 text-black font-medium'>Budownictwo</h5>

                <p className='w-11/12 mt-3 font-light text-sm text-center text-thirdColor leading-4'>
                    Obiekty zamieszkania zbiorowego / Obiekty użyteczności publicznej / Obiekty z zakresu budownictwa
                    przemysłowego
                </p>

                <Link href='/budownictwo'>
                    <a href="#" className="flex items-center justify-center w-28 h-8 cursor-pointer border hover:pl-10
                hover:bg-primaryColor duration-300 delay-100 border-primaryColor text-primaryColor mt-3
