            ...
            mt-24 lg:mb-24'>
                ...
                <div className='w-full flex items-start justify-center sm:flex-col-reverse lg:flex-row'>
                    ...
                    <div className='sm:w-full lg:w-1/2 flex flex-col'>
                        <Heading heading='Dlaczego my?'/>
                        <Description spanText='Zarządzamy firmą zgodnie z europejskimi'
                                     description='standardami, poprzez cykliczną realizacją etapów: planowania, wykonania,
                                      sprawdzenia i działania. Budujemy zgodnie z właściwymi dyrektywami UE i właściwymi
                                      technicznymi specyfikacjami interoperacyjności. Solidność i bezpieczeństwo to
