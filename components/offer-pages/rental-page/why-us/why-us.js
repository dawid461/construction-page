            ...
            mt-24 lg:mb-24'>
                ...
                <div className='w-full flex items-start justify-center sm:flex-col-reverse lg:flex-row'>
                    ...
                    <div className='sm:w-full lg:w-1/2 flex flex-col'>
                        ...
                        <Description spanText='Do wykonania oferowanego zakresu'
                                     description=' posiadamy zaplecze sprzętowe pochodzące z renomowanych firm polskich
                                     i zagranicznych. Sprzęt wynajmujemy wyłącznie z operatorem.'
                        />
                    </div>
